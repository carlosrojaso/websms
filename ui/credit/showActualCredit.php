...
$_sql = "SELECT not_consumed_credit, planned_credit, free_credit FROM actual_planned_credit WHERE id_client="."$_SESSION[usuario_identificacion_sesion]";
$r = $db->select($_sql);
...
<table width="70%"  border="0" cellspacing="1" align="center">
	<tr>
		<td colspan="2" class="titulo"><b><?php echo $title;?></b></td>
	</tr>
	<?php
	//foreach($credits as $cont => $value){
