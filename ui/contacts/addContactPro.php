...
/*
$obj->setJS("../../includes/prototype.js");
$obj->setJS("../../includes/validation.js");
$obj->setJS("../../includes/validation_form.js");
$obj->setJS("../../includes/user.js");
*/


$_sql1="SELECT sex_cd, sex_nm FROM  sex WHERE sex_lang ='".$lang."'";
...
?>
<br><br>
<form name='forma' id='forma' method='post' action='../../control/contacts/addContactPro.php' >
	<table width="5%" border="0" align="center" cellpadding="0" cellspacing="1" id="addContact">	  
	  	  <tr>
	 ...
	 <tr>
	  ...
	  <tr>
		<td class="subtitulo" colspan="2"><input name="info" type="checkbox"/><?php echo $link;?></td>
	 </tr>
	  <tr>
