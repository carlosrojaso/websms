...
/**
 * editUserProfesional.php
 * 
 * Control Editar Usuarios Profesional.
...
$obj = new simplepage();
$obj->setTitle("Edición de datos personales - Profesional");
...
$r = $db->select('SELECT geo_country_cd,geo_town FROM geography WHERE geo_postal_cd=' . $codigo_postal);
