<?php
/**
 * addUserParticular.php
 * 
 * Control Agregar Usuarios Externos (Particulares).
...
if($db->row_count != 0){
	echo
	'
	<form action="../../ui/user/addUserPar.php?lang=SP" method="POST" id="errorData" name"errorData">				
		<br><br><br><br><br>
		<table align="center">
			<tr>
				<td class="titulo">
...
<table align="center">
	<tr>
		<td class="titulo">
			...
			Puede acceder a su cuenta desde ya y empezar a disfrutar de los servicios que le ofrece Onspot.<br>
