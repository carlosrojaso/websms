...
class ip2more
{
  ...
  */
  var $idx_file        = 'data/ips.idx';
  
  /*
  * IPs Database File
  */
  var $db_file         = 'data/ips.db';
  
  /*
  * Countries List File
  */
  var $countries_file  = 'data/countries.php';
  ...
  */
  var $null_country = array('name'=>"Spain", 'iso2'=>"ES", 'iso3'=>"ESP", 'fips104'=>"SP", 'isono'=>"724.00", 'capital'=>"Madrid", 'region'=>"Europe", 'currency'=>"Euro", 'currency_code'=>"EUR");
  /*
  * WHOIS Service URL
  */
