...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
function escribe_formulario_fecha_vacio($nombrecampo,$nombreformulario, $value){
	global $raiz;
	echo '
	<input value="'.$value.'" name="'.$nombrecampo.'" id="'.$nombrecampo.'" size="10" READONLY>
	<img src="../../images/b_calendar.png" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')">
	';	
}

function escribe_formulario_fecha_vacio2($nombrecampo,$nombreformulario,$value){
	global $raiz;
	echo '
	<input value="'.$value.'"  name="'.$nombrecampo.'" id="'.$nombrecampo.'" size="10" READONLY>
	<img src="../../images/b_calendar.png" onclick="editClient(); muestraCalendario2(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')">
	';	
}

function escribe_formulario_fecha_vacio3($nombrecampo,$nombreformulario,$value){
	global $raiz;
	echo '
	<input value="'.$value.'"  name="'.$nombrecampo.'" id="'.$nombrecampo.'" size="10" READONLY >
	<img src="../../images/b_calendar.png" onclick="show_submitForm(true); editUser(); muestraCalendario2(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')">
	';	
}

function escribe_formulario_fecha_vacio4($nombrecampo,$nombreformulario,$value){
	global $raiz;
	echo '
	<input  value="'.$value.'"  name="'.$nombrecampo.'" id="'.$nombrecampo.'" size="10" READONLY >	
	';	
